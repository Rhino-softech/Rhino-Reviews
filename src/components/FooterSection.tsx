      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8">
          <div className="col-span-2">
            <div className="flex items-center">
              <span className="text-white font-extrabold text-xl"><a href="https://rhino-review.rhinosoft.in/">Rhino Review</a></span>
            </div>
        ...
        <div className="border-t border-gray-800 pt-8 mt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <p className="mt-8 md:mt-0 text-base text-gray-400 md:order-1">
            ...
            2025 
            powered by @<a href="https://rhinosoft.in/" target="_blank">Rhinosoft.in</a> / All rights reserved.
          </p>
        </div>
      </div>
    </footer>
