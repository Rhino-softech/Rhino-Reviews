...
import { MapPin, Plus, Edit, Trash2, Copy, ExternalLink, AlertCircle, CheckCircle2, XCircle } from "lucide-react"
    ...
    <TooltipProvider>
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50/30">
          ...
          <div className="flex-1 md:ml-64 p-3 sm:p-4 lg:p-8">
            <div className="max-w-7xl mx-auto">
              ...
              >
                ...
                >
                  <h1 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold bg-gradient-to-r from-blue-700 via-purple-700 to-pink-700 bg-clip-text text-transparent mb-4">
                    Location Management
                  </h1>
                  <p className="text-lg sm:text-xl text-slate-600 max-w-3xl mx-auto leading-relaxed">
                    Effortlessly manage your business locations and tailor review collection for each branch.
                  </p>
                </motion.div>
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-start gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-3 text-sm">
                        <div className="bg-white/60 p-3 rounded-lg flex items-center gap-2">
                        ...
                        <div className="bg-white/60 p-3 rounded-lg flex items-center gap-2">
                          <CheckCircle2 className="h-4 w-4 text-green-500" />
                          <span className="font-bold text-blue-700">Enterprise:</span> Unlimited
                        </div>
                      </div>
          ...
          <DialogContent className="sm:max-w-md rounded-2xl p-6">
            <DialogHeader className="mb-4">
              ...
              <DialogDescription className="text-slate-600">
                Add a new branch or location for your business
              </DialogDescription>
            </DialogHeader>
            <div className="space-y-5 py-4">
              ...
              <div className="space-y-2">
                <Label htmlFor="location" className="text-base font-medium text-slate-700">
                ...
                <Textarea
                  ...
                  className="rounded-lg border-slate-300 focus:border-blue-500 focus:ring-blue-500 min-h-[80px]"
                />
              </div>
              <div className="space-y-2">
                <Label htmlFor="googleReviewLink" className="text-base font-medium text-slate-700">
                  Google Review Link <span className="text-red-500">*</span>
                </Label>
                <Input
                  id="googleReviewLink"
                  placeholder="e.g., https://g.page/r/your-business-name/review"
              ...
              <div className="flex items-center justify-between pt-2">
                <Label htmlFor="isActive" className="cursor-pointer text-base font-medium text-slate-700">
                  Active Location
                </Label>
                <Switch
                  id="isActive"
            ...
            <DialogFooter className="pt-4 border-t border-slate-200">
              <Button
                ...
                className="rounded-lg px-5 py-2.5 text-base"
              >
                Cancel
              </Button>
              <Button
                onClick={handleAddBranch}
                className="bg-blue-600 hover:bg-blue-700 text-white rounded-lg px-5 py-2.5 text-base"
              >
                Add Location
              </Button>
            </DialogFooter>
        ...
        <Dialog open={isEditDialogOpen} onOpenChange={setIsEditDialogOpen}>
          <DialogContent className="sm:max-w-md rounded-2xl p-6">
            <DialogHeader className="mb-4">
              ...
              <DialogDescription className="text-slate-600">Update your branch or location details</DialogDescription>
            </DialogHeader>
            {currentBranch && (
              <div className="space-y-5 py-4">
                <div className="space-y-2">
                  <Label htmlFor="edit-name" className="text-base font-medium text-slate-700">
                    Branch Name <span className="text-red-500">*</span>
                  </Label>
                  <Input
                    id="edit-name"
                ...
                <div className="space-y-2">
                  <Label htmlFor="edit-location" className="text-base font-medium text-slate-700">
                    Address <span className="text-red-500">*</span>
                  </Label>
                  <Textarea
                    id="edit-location"
                ...
                <div className="space-y-2">
                  <Label htmlFor="edit-googleReviewLink" className="text-base font-medium text-slate-700">
                    Google Review Link <span className="text-red-500">*</span>
                  </Label>
                  <Input
                ...
                <div className="flex items-center justify-between pt-2">
                  <Label htmlFor="edit-isActive" className="cursor-pointer text-base font-medium text-slate-700">
                    Active Location
                  </Label>
                  <Switch
                    id="edit-isActive"
        ...
        <Dialog open={isDeleteDialogOpen} onOpenChange={setIsDeleteDialogOpen}>
          <DialogContent className="sm:max-w-md rounded-2xl p-6">
            <DialogHeader className="mb-4">
              <DialogTitle className="text-2xl font-bold text-slate-800">Delete Location</DialogTitle>
              <DialogDescription className="text-slate-600">
              ...
              <div className="py-4">
                <Card className="border-red-200 bg-red-50 shadow-sm">
                  <CardContent className="p-4 flex items-center gap-4">
                    ...
                    <div>
                      <h3 className="font-bold text-slate-800 text-lg">{currentBranch.name}</h3>
            ...
            <DialogFooter className="pt-4 border-t border-slate-200">
              ...
              <Button variant="destructive" onClick={handleDeleteBranch} className="rounded-lg px-5 py-2.5 text-base">
                Delete Location
              </Button>
            </DialogFooter>
          </DialogContent>
